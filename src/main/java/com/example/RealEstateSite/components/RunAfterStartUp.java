...
public class RunAfterStartUp {
    ...
    public void runAfter() {
        ...
        if (testUser.isEmpty()) {
            ...
            Post post = new Post("user1", userContact1.getFirstName(), "Ha'alon 56", "Dimona", 3, 1, 100, "Demo description", userContact1.getPhoneNumber(), userContact1.getEmail(), PropertyType.RENT, 1000, userContact1.getUsername() + "Ha'alon 56");
            Post post1 = new Post("user1", userContact1.getFirstName(), "Ha'maapil 1055", "Dimona", 4, 2, 120, "Demo description", userContact1.getPhoneNumber(), userContact1.getEmail(), PropertyType.SALE, 1200000, userContact1.getUsername() + "Ha'maapil 1055");
